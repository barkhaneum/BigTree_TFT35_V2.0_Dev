...
#define _LANGUAGE_RU_H_
    ...
    #define RU_MORESETTING          "§Ò§à§Ý§î§ê§Ö §¯§Ñ§ã§ä§â§à§Û§Ü§Ú"
    #define RU_SCREEN_INFO          "§ª§ß§æ§à"
    #define RU_WHITE                "§Ò§Ö§Ý§í§Û"
    #define RU_BLACK                "§é§×§â§ß§í§Û"
    #define RU_BLUE                 "§ã§Ú§ß§Ú§Û"
    #define RU_RED                  "§Ü§â§Ñ§ã§ß§í§Û"
    #define RU_GREEN                "§Ù§Ö§Ý§Ö§ß§í§Û"
    #define RU_CYAN                 "§ã§Ú§ß§Ú§Û"
    #define RU_YELLOW               "§Ø§×§Ý§ä§í§Û"
    #define RU_BROWN                "§Ü§à§â§Ú§é§ß§Ö§Ó§í§Û"
    #define RU_GRAY                 "§ã§Ö§â§í§Û"
